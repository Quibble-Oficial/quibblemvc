...
<head>
<title>Buy Muze Bootstrap 5 API Key Page</title>
<meta charset="UTF-8">
<meta name="description" content="Presenting Muze, All-in-one Bootstrap 5 API Key Admin Dashboard, 30+ Premium HTML pages, 500+ components, dark mode, RTL. Starts @ Only $35">
<meta name="keywords" content="No Search results, HTML api key template, api key template">
<meta name="title" content="Muze Bootstrap 5 API Key Templates, Themes, & Dashboard">
...
<body class="bg-gray-100 apikeys-template">
...
<div class="main-content">
                        ...
                        <li class="nav-item">
                          ...
                          <div class="collapse collapse-box" id="AccountPage3" data-bs-parent="#submenu4">
                            <ul class="nav nav-sm flex-column">
                              ...
                              <li class="nav-item">
                                <a href="api-keys.html" class="nav-link active">API keys</a>
                              </li>
                            </ul>
                          </div>
                        </li>
    ...
    <div class="container-fluid px-0">
      <div class="row align-items-center">
        <div class="col">
          ...
          <h1 class="h2 mb-0 lh-sm">API Keys</h1>
        </div>
  ...
  <div class="p-3 p-xxl-5">
    <div class="container-fluid px-0">
      <div class="row">
        <div class="col-12">
          <div class="card rounded-12 shadow-dark-80 border border-gray-50 mb-3 mb-xl-4 px-3 pt-3">
            <div class="card-body p-0 p-md-4">
              <h5 class="font-weight-semibold opensans-font pb-1 pb-md-4">Performance</h5>
              <div class="row pb-md-2">
                <div class="col-md-6 col-lg-12 col-xl-6 col-xxl-4">
                  <div class="card mb-4 rounded-12 shadow border border-gray-200">
                    <div class="card-body p-3 p-xl-3 p-xxl-4">
                      <div class="row align-items-center">
                        <div class="col-5">
                          <span class="caption text-gray-600 d-block mb-1">API calls</span>
                ...
                <div class="col-md-6 col-lg-12 col-xl-6 col-xxl-4">
                  <div class="card mb-4 rounded-12 shadow border border-gray-200">
                    <div class="card-body p-3 p-xl-3 p-xxl-4">
                      <div class="row align-items-center">
                        <div class="col-5">
                          <span class="caption text-gray-600 d-block mb-1">Errors</span>
                          <span class="h3 mb-0 text-truncate">12 pages</span>
                ...
                <div class="col-md-6 col-lg-12 col-xl-6 col-xxl-4">
                  <div class="card mb-4 rounded-12 shadow border border-gray-200">
                    <div class="card-body p-3 p-xl-3 p-xxl-4">
                      <div class="row align-items-center">
                        <div class="col-5">
                          <span class="caption text-gray-600 d-block mb-1">Quota</span>
              ...
              <h5 class="font-weight-semibold opensans-font pt-md-5 pb-md-4">Manage your API keys</h5>
              <div class="table-responsive">
                <table class="table table-borderless card-table table-nowrap overflow-hidden">
                  <thead>
                    <tr>
                      <th>Name</th>
                      <th>API Key</th>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <div class="d-flex align-items-center">
                          <span style="min-width: 16px;"><img src="<?= $base;?>/assets/svg/icons/key.svg" alt="Copy"></span>
                          <span class="text-gray-600 mx-2">••••••••••••••••••••••••••••••••••••••</span>
                          <a style="min-width: 16px;" href="#0"><img src="/assets/svg/icons/copy.svg" alt="Copy"></a>
                        </div>
                      </td>
                      <td>
                        <div class="dropdown text-end">
                          <a href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img src="<?= $base;?>/assets/svg/icons/setting1.svg" alt="Setting">
                            <span class="ps-2"><img src="<?= $base;?>/assets/svg/icons/down-arrow.svg" alt="Setting"></span>
                          </a>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="d-flex align-items-center">
                          <span style="min-width: 16px;"><img src="<?= $base;?>/assets/svg/icons/key.svg" alt="Copy"></span>
                          <span class="text-gray-600 mx-2">••••••••••••••••••••••••••••••••••••••</span>
                          <a style="min-width: 16px;" href="#0"><img src="<?= $base;?>/assets/svg/icons/copy.svg" alt="Copy"></a>
                        </div>
                      </td>
                      <td>
                        <div class="dropdown text-end">
