            ...
            <div class="card-body px-0">
              <div class="d-flex align-items-center border-bottom border-gray-200 pb-3 mb-2 px-3 px-md-4">
                ...
                <div class="ms-auto pe-md-2">
                  <div class="dropdown export-dropdown">
                    <a href="#" role="button" id="UserOverview" data-bs-toggle="dropdown" aria-expanded="false" class="btn btn-outline-dark border-gray-700 text-gray-700 px-3"><span>Today </span> <svg class="ms-2" xmlns="http://www.w3.org/2000/svg" width="13" height="13" viewBox="0 0 13 13">
              ...
              <div class="card-body-inner px-3 px-md-4">
                <div id="MuzeDoubleLineTwo" class="px-md-2"></div>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="row ps-xl-3 pt-xl-3">
              ...
              <div class="col-lg-6">
                <div class="get-startedtwo">
                  <img src="<?= $base;?>/assets/images/placeholder1.png" class="img-fluid" alt="img">
                </div>
              </div>
            </div>
          </div>
