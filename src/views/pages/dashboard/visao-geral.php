  ...
  <div class="px-3 px-xxl-5 py-3 py-lg-4 border-bottom border-gray-200 after-header">
    <div class="container-fluid px-0">
      <div class="row align-items-center">
        <div class="col">
          <h1 class="h2 mb-0">Olá, <?= $loggedUser->nome; ?>!</h1>
        </div>
            ...
            <div class="card-body p-3 p-xl-3 p-xxl-4">
              <div class="row align-items-center">
                <div class="col-5 col-xxl-6">
                  ...
                  <span class="h3 mb-0"><?= number_format($totalReclamacoesMes, 0, ',', '.'); ?></span>
                </div>
...
const dadosDiarios = <?= json_encode($dadosMesAtual); ?>;
  const nomeMes = "<?= $nomeMes ?? 'Mês Atual'; ?>";
...
const pieData = <?= json_encode($dadosPieChart); ?>;
...
Highcharts.chart('MuzePieChartOne', {
  ...
  tooltip: {
    ...
    pointFormat: '<span style="color:{point.color}">Total</span>: <b>{point.y}</b> ({point.percentage:.1f}%)<br/>'
  },
  series: [{
    innerSize: '86%',
    dataLabels: [{
