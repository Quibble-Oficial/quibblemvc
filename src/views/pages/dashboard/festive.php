...
<head>
<title>Festive - Muze Documentation | Muze - Responsive Website Template</title>
<meta charset="UTF-8">
<meta name="description" content="Admin Dashboard template with bootstrap grids">
<meta name="keywords" content="admin dashboard, dashboard grid system, bootstrap admin template">
...
<body class="bg-gray-100 festive-template">
      ...
      <li class="nav-item">
        ...
        <div class="collapse collapse-box show" id="sidebarDashboards" data-bs-parent="#accordionExample">
          <ul class="nav nav-sm flex-column">
            ...
            <li class="nav-item">
              <a href="festive.html" class="nav-link active">Festive</a>
            </li>
          </ul>
        </div>
      </li>
...
<div class="main-content">
  ...
  <div class="px-3 px-xxl-5 py-3 py-lg-4 border-bottom border-gray-200 after-header">
    <div class="container-fluid px-0">
      <div class="row align-items-center">
        <div class="col">
          <h1 class="h2 mb-0">Festive</h1>
        </div>
        <div class="col-auto d-flex align-items-center my-2 my-sm-0">
          <a href="#" class="btn btn-lg btn-outline-dark px-3 me-2 me-md-3"><span class="ps-1">Invite</span> <svg class="ms-4" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14">
          ...
          <div class="dropdown export-dropdown">
            <a href="#" role="button" id="Exportbtn" data-bs-toggle="dropdown" aria-expanded="false" class="btn btn-lg btn-warning ms-1 px-3"><span class="ps-1">Export</span> <svg class="ms-4" xmlns="http://www.w3.org/2000/svg" width="14" height="7.875" viewBox="0 0 14 7.875">
  ...
  <div class="row g-0">
    <div class="col-md-7 col-xxl-9">
      <div class="p-3 p-xxl-5 border-end border-gray-200">
        <div class="container-fluid px-0">
              ...
              <div class="card rounded-12 shadow-dark-80 border border-gray-50">
                <div class="card-body px-0">
                  <div class="d-flex align-items-center border-bottom border-gray-200 pb-3 mb-2 px-3 px-md-4">
                    <h5 class="card-header-title mb-0 font-weight-semibold ps-md-2">User Overview</h5>
                  ...
                  <div class="card-body-inner px-3 px-md-4">
                    <div id="MuzeAreaChart" class="px-md-2"></div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-12 col-xxl-4 mb-4">
              <div class="card rounded-24 shadow-dark-80 border border-gray-50 py-3 px-2 p-md-4">
                <div class="p-2">
                  ...
                  <h5 class="font-weight-semibold title-box">App Wireframes</h5>
                  <div class="pt-4 pb-4">
            ...
            <div class="col-12 col-xxl-4 mb-4">
              <div class="card rounded-24 shadow-dark-80 border border-gray-50 py-3 px-2 p-md-4">
                <div class="p-2">
                  ...
                  <h5 class="font-weight-semibold title-box">Bootstrap 5 Templates Documentation</h5>
                  <div class="pt-4 pb-4">
                    <span class="small font-weight-semibold mb-2 d-block">Progress</span>
                    <div class="progress rounded-pill" style="height: 5px;width: 100%;">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="position-relative rounded-12 mb-5 border border-gray-300 bg-gray-100 zIndex-0" role="alert">
                <div class="row g-0">
                  <div class="col-lg-12 col-xl-7 col-xxl-6 p-xxl-3">
                  ...
                  <div class="col-xl-6">
                    <div class="get-started-img get-started-two end-0">
                      <img src="<?= $base;?>/assets/images/placeholder3.svg" class="img-fluid" alt="img">
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="row">
                ...
                <div class="col-sm-6 col-md-12">
                  <div class="card mb-4 rounded-12 shadow border border-gray-50">
                    <div class="card-body p-3 px-xxl-4">
                      <div class="row align-items-center">
                        <div class="col-auto">
                          <span class="badge badge-size-xl rounded-24 py-2 bg-pink-50 text-gray-600"><img src="<?= $base;?>/assets/svg/icons/wallet.svg" alt="Wallet"></span>
                        </div>
                        <div class="col">
                ...
                <div class="col-sm-6 col-md-12">
                  <div class="card mb-4 rounded-12 shadow border border-gray-50">
                    <div class="card-body p-3 px-xxl-4">
                      <div class="row align-items-center">
                        <div class="col-auto">
                          <span class="badge badge-size-xl rounded-24 py-2 bg-cyan-50 text-gray-600"><img src="<?= $base;?>/assets/svg/icons/goals.svg" alt="Wallet"></span>
                        </div>
                        <div class="col">
                ...
                <div class="col-sm-6 col-md-12">
                  <div class="card mb-4 rounded-12 shadow border border-gray-50">
                    <div class="card-body p-3 px-xxl-4">
                      <div class="row align-items-center">
                        <div class="col-auto">
                          <span class="badge badge-size-xl rounded-24 py-2 bg-yellow-50 text-gray-600"><img src="<?= $base;?>/assets/svg/icons/profile-visits.svg" alt="Wallet"></span>
                        </div>
                        <div class="col">
            ...
            <div class="col-12 col-xxl-8 mb-4">
              <div class="card rounded-12 shadow-dark-80 overflow-hidden border border-gray-50">
                <div class="card-body px-0 pb-0">
                  <div class="d-flex align-items-center border-bottom border-gray-200 pb-3 px-3 px-md-4">
                    <h5 class="card-header-title mb-0 font-weight-semibold ps-md-2">Top Posts</h5>
                  ...
                  <div class="list-group list-group-flush my-n3">
                    <div class="list-group-item px-4">
                      <div class="row align-items-center px-1 px-md-2">
                        <div class="col-auto ps-0 ps-md-3">
                          <span class="avatar avatar-sm avatar-circle">
                            <img class="avatar-img" src="<?= $base;?>/assets/images/avatar16.png" alt="Avatars">
                          </span>
                        </div>
                        <div class="col ps-0">
                          <h6 class="mb-1 font-weight-semibold">
                            <a href="#">Summer Roadtrip</a>
                          </h6>
                        </div>
                        <div class="col-auto pe-0 pe-md-3">
                          <div class="text-end">
                            <svg class="me-3" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 16 16">
                            ...
                            </svg><span class="badge rounded-pill py-2 bg-gray-100 text-gray-600">39.6%</span>
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="row align-items-center px-1 px-md-2">
                        <div class="col-auto ps-0 ps-md-3">
                          <span class="avatar avatar-circle avatar-sm">
                            <img class="avatar-img" src="<?= $base;?>/assets/images/avatar17.png" alt="Avatars">
                          </span>
                        </div>
                        <div class="col ps-0">
                          <h6 class="mb-1 font-weight-semibold">
                            <a href="#">Dinner with Family</a>
                          </h6>
                        </div>
                        <div class="col-auto pe-0 pe-md-3">
                          <div class="text-end">
                            ...
                            </svg><span class="badge rounded-pill py-2 bg-gray-100 text-gray-600">25.7%</span>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="list-group-item px-4">
                      <div class="row align-items-center px-1 px-md-2">
                        <div class="col-auto ps-0 ps-md-3">
                          <span class="avatar avatar-circle avatar-sm">
                            <img class="avatar-img" src="<?= $base;?>/assets/images/avatar18.png" alt="Avatars">
                          </span>
                        </div>
                        <div class="col ps-0">
                          <h6 class="mb-1 font-weight-semibold">
                            <a href="#">Gorgeous Sunset</a>
                          </h6>
                        </div>
                        <div class="col-auto pe-0 pe-md-3">
                          <div class="text-end">
                            <svg class="me-3" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 14 14">
                            ...
                            </svg><span class="badge rounded-pill py-2 bg-red-50 text-dnd">10.3%</span>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="list-group-item px-4">
                      <div class="row align-items-center px-1 px-md-2">
                        <div class="col-auto ps-0 ps-md-3">
                          <span class="avatar avatar-circle avatar-sm">
                            <img class="avatar-img" src="<?= $base;?>/assets/images/avatar19.png" alt="Avatars">
                          </span>
                        </div>
                        <div class="col ps-0">
                          <h6 class="mb-1 font-weight-semibold">
                        ...
                        <div class="col-auto pe-0 pe-md-3">
                          <div class="text-end">
                            ...
                            </svg><span class="badge rounded-pill py-2 bg-gray-100 text-gray-600">56.4%</span>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="d-flex align-items-center p-3 p-md-4 border-top border-gray-200">
                    <a href="#" class="tiny font-weight-semibold mx-auto btn btn-link link-dark">See all data<svg class="ms-1" data-name="icons/tabler/chevron right" xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 16 16">
          ...
          <div class="row">
            <div class="col-xxl-4 mb-4">
              <div class="card rounded-24 shadow-dark-80 p-4 h-100 bg-gray-800">
                <div class="p-2">
                  <div class="d-flex align-items-center mb-xxl-5">
                    <div class="ms-auto dropdown">
                      <a href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false" class="btn btn-dark-100 btn-icon btn-sm rounded-circle">
                        <svg data-name="Icons/Tabler/Notification" xmlns="http://www.w3.org/2000/svg" width="13.419" height="13.419" viewBox="0 0 13.419 13.419">
                          <rect data-name="Icons/Tabler/Dots background" width="13.419" height="13.419" fill="none"></rect>
                          <path d="M0,10.4a1.342,1.342,0,1,1,1.342,1.342A1.344,1.344,0,0,1,0,10.4Zm1.15,0a.192.192,0,1,0,.192-.192A.192.192,0,0,0,1.15,10.4ZM0,5.871A1.342,1.342,0,1,1,1.342,7.213,1.344,1.344,0,0,1,0,5.871Zm1.15,0a.192.192,0,1,0,.192-.192A.192.192,0,0,0,1.15,5.871ZM0,1.342A1.342,1.342,0,1,1,1.342,2.684,1.344,1.344,0,0,1,0,1.342Zm1.15,0a.192.192,0,1,0,.192-.192A.192.192,0,0,0,1.15,1.342Z" transform="translate(5.368 0.839)" fill="#1E1E1E"></path>
                        </svg>
                      </a>
                      <ul class="dropdown-menu">
                        <li class="dropdown-sub-title">
                  ...
                  <div class="pt-5">
                    <h6 class="font-weight-medium mb-0 text-white">In a nutshell</h6>
                    <h3 class="font-weight-semibold text-white">Audience</h3>
                    <p class="mb-2 text-white">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration.</p>
                  </div>
                </div>
              </div>
            </div>
            <div class="col-xxl-4 mb-4">
              <div class="card rounded-24 shadow-dark-80 p-4 h-100 bg-indigo-light">
                <div class="p-2">
                  <div class="d-flex align-items-center mb-xxl-5">
                    <div class="ms-auto dropdown">
                      <a href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false" class="btn btn-dark-100 btn-icon btn-sm rounded-circle">
                  ...
                  <div class="pt-5">
                    <h6 class="font-weight-medium mb-0 text-white">Tutorials</h6>
                    <h3 class="font-weight-semibold text-white">Performace</h3>
                    <p class="mb-2 text-white">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration.</p>
                  </div>
                </div>
              </div>
            </div>
            <div class="col-xxl-4 mb-md-4">
              <div class="card rounded-24 shadow-dark-80 p-4 h-100 bg-teal-500">
                <div class="p-2">
                  <div class="d-flex align-items-center mb-xxl-5">
                    <div class="ms-auto dropdown">
                      <a href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false" class="btn btn-dark-100 btn-icon btn-sm rounded-circle">
                  ...
                  <div class="pt-5">
                    <h6 class="font-weight-medium mb-0 text-white">At a glancce</h6>
                    <h3 class="font-weight-semibold text-white">Revenue</h3>
                    <p class="mb-2 text-white">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration.</p>
                  </div>
                </div>
              </div>
    ...
    <div class="col-md-5 col-xxl-3 bg-gray-100">
      <div class="p-3 p-xxl-5">
        <h2 class="h1 pt-2  ">Instantly engage with your fans.</h2>
        <div class="avatar-group my-3 py-md-4">
          ...
          <span class="avatar avatar-lg avatar-circle">
            <span class="avatar-initials avatar-dark-light border-transprant">+9</span>
          </span>
        </div>
        <div class="d-grid">
          <a href="#0" class="btn btn-xl btn-dark rounded-pill px-2">Start a conversation</a>
        </div>
      </div>
      <div class="pt-4 mt-md-2">
        <div class="d-flex align-items-center border-bottom border-gray-200 pb-4 px-3 px-xxl-5">
          <h3 class="mb-0 mb-md-2">My List</h3>
          <div class="ms-auto dropdown mb-md-2">
            <a href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false" class="btn btn-dark-100 bg-gray-200 btn-icon btn-sm rounded-circle">
              <svg data-name="Icons/Tabler/Notification" xmlns="http://www.w3.org/2000/svg" width="13.419" height="13.419" viewBox="0 0 13.419 13.419">
                <rect data-name="Icons/Tabler/Dots background" width="13.419" height="13.419" fill="none"></rect>
                <path d="M0,10.4a1.342,1.342,0,1,1,1.342,1.342A1.344,1.344,0,0,1,0,10.4Zm1.15,0a.192.192,0,1,0,.192-.192A.192.192,0,0,0,1.15,10.4ZM0,5.871A1.342,1.342,0,1,1,1.342,7.213,1.344,1.344,0,0,1,0,5.871Zm1.15,0a.192.192,0,1,0,.192-.192A.192.192,0,0,0,1.15,5.871ZM0,1.342A1.342,1.342,0,1,1,1.342,2.684,1.344,1.344,0,0,1,0,1.342Zm1.15,0a.192.192,0,1,0,.192-.192A.192.192,0,0,0,1.15,1.342Z" transform="translate(5.368 0.839)" fill="#6c757d"></path>
              </svg>
        ...
        <div class="p-3 px-xxl-5 pt-md-4">
          ...
          <div class="check-list pt-1">
            ...
            <div class="form-check d-flex mb-2 pt-1 pb-1">
              <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault9">
              <label class="form-check-label ms-2" for="flexCheckDefault9">
                Arrange a team meeting
              </label>
            </div>
          </div>
        </div>
        <div class="row g-0 align-items-center checklist-box p-3 px-xxl-5 py-md-3 border-top border-gray-200 mt-2">
          <div class="col mt-md-1">
            <textarea class="form-control bg-transparent py-0" rows="1" placeholder="New Item..."></textarea>
          </div>
  ...
  <div class="p-3 px-xxl-5 pb-lg-5 pt-md-0">
    <footer>
...
<script>
//Muze Area Chart JavaScript
var options = {
  series: [{
  name: '2020',
  data: [31, 40, 28, 51, 42, 75, 60, 45, 70, 30, 15, 50]
}, {
  name: '2021',
  data: [11, 32, 45, 32, 34, 52, 41, 68, 35, 50, 70, 75]
}],
  chart: {
  height: 330,
  type: 'area',
...
var chart = new ApexCharts(document.querySelector("#MuzeAreaChart"), options);
chart.render();
