...
<head>
<title>Buy Muze Bootstrap 5 Best Calendar Page</title>
<meta charset="UTF-8">
<meta name="description" content="Presenting Muze, All-in-one Bootstrap 5 Calendar Admin Dashboard, 30+ Premium HTML Pages, 500+ components, dark mode, RTL. Starts @ Only $35">
<meta name="title" content="Muze Bootstrap 5 Calendar Templates, Themes, & Dashboard">
<meta name="keywords" content="calendar templates bootstrap , best bootstrap calendar templates, calendar in bootstrap 5">
...
<link href="<?= $base;?>/assets/vendor/fullcalendar/main.min.css" rel="stylesheet" type="text/css" media="all">
<!-- Muze Theme CSS -->
<link href="<?= $base;?>/assets/css/theme.min.css" rel="stylesheet" type="text/css" media="all">
</head>
<body class="bg-gray-100 calendar-template">
...
<div class="main-content">
          ...
          <div class="col-auto d-flex flex-wrap align-items-center icon-blue-hover ps-0">
            ...
            <div class="dropdown grid-option">
              <a href="#" class="text-dark ms-4 ms-xxl-5 h5 mb-0" data-bs-toggle="dropdown" aria-expanded="false" id="grid">
                <svg data-name="Icons/Tabler/Settings" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                  ...
                  <path d="M16.115,24a2.4,2.4,0,0,1-2.4-2.4V16.115a2.4,2.4,0,0,1,2.4-2.4H21.6a2.4,2.4,0,0,1,2.4,2.4V21.6A2.4,2.4,0,0,1,21.6,24Zm-.343-7.885V21.6a.343.343,0,0,0,.343.343H21.6a.343.343,0,0,0,.343-.343V16.115a.343.343,0,0,0-.343-.343H16.115A.343.343,0,0,0,15.772,16.115ZM2.4,24A2.4,2.4,0,0,1,0,21.6V16.115a2.4,2.4,0,0,1,1.6-2.4H7.885a2.4,2.4,0,0,1,2.4,2.4V21.6a2.4,2.4,0,0,1-2.4,2.4Zm-.343-7.885V21.6a.343.343,0,0,0,.343.343H7.885a.343.343,0,0,0,.343-.343V16.115a.343.343,0,0,0-.343-.343H2.4A.343.343,0,0,0,2.057,16.115Zm14.058-5.829a2.4,2.4,0,0,1-2.4-2.4V2.4a2.4,2.4,0,0,1,2.4-2.4H21.6A2.4,2.4,0,0,1,24,2.4V7.885a2.4,2.4,0,0,1-2.4,2.4ZM10.515,1.6V5.257a.229.229,0,0,0,.229.229H14.4a.229.229,0,0,0,.229-.229V1.6a.229.229,0,0,0-.229-.229H10.743A.229.229,0,0,0,10.515,1.6ZM1.6,6.857A1.6,1.6,0,0,1,0,5.257V1.6A1.6,1.6,0,0,1,1.6,0H5.257a1.6,1.6,0,0,1,1.6,1.6V5.257a1.6,1.6,0,0,1-1.6,1.6ZM1.372,1.6V5.257a.229.229,0,0,0,.229.229H5.257a.229.229,0,0,0,.229-.229V1.6a.229.229,0,0,0-.229-.229H1.6A.229.229,0,0,0,1.372,1.6Z" transform="translate(0 0)" fill="#1e1e1e"/>
                </svg>
              </a>
            ...
            <div class="dropdown grid-option">
              <a href="#" class="text-dark ms-4 ms-xxl-5 h5 mb-0" data-bs-toggle="dropdown" aria-expanded="false" id="grid">
                <svg data-name="Icons/Tabler/Settings" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                  <rect data-name="Icons/Tabler/apps background" width="24" height="24" fill="none"/>
                  <path d="M16.115,24a2.4,2.4,0,0,1-2.4-2.4V16.115a2.4,2.4,0,0,1,2.4-2.4H21.6a2.4,2.4,0,0,1,2.4,2.4V21.6A2.4,2.4,0,0,1,21.6,24Zm-.343-7.885V21.6a.343.343,0,0,0,.343.343H21.6a.343.343,0,0,0,.343-.343V16.115a.343.343,0,0,0-.343-.343H16.115A.343.343,0,0,0,15.772,16.115ZM2.4,24A2.4,2.4,0,0,1,0,21.6V16.115a2.4,2.4,0,0,1,1.6-2.4H7.885a2.4,2.4,0,0,1,2.4,2.4V21.6a2.4,2.4,0,0,1-2.4,2.4Zm-.343-7.885V21.6a.343.343,0,0,0,.343.343H7.885a.343.343,0,0,0,.343-.343V16.115a.343.343,0,0,0-.343-.343H2.4A.343.343,0,0,0,2.057,16.115Zm14.058-5.829a2.4,2.4,0,0,1-2.4-2.4V2.4a2.4,2.4,0,0,1,2.4-2.4H21.6A2.4,2.4,0,0,1,24,2.4V7.885a2.4,2.4,0,0,1-2.4,2.4ZM10.515,1.6V5.257a.229.229,0,0,0,.229.229H21.6a.229.229,0,0,0,.229-.229V1.6a.229.229,0,0,0-.229-.229H10.743A.229.229,0,0,0,10.515,1.6ZM1.6,6.857A1.6,1.6,0,0,1,0,5.257V1.6A1.6,1.6,0,0,1,1.6,0H5.257a1.6,1.6,0,0,1,1.6,1.6V5.257a1.6,1.6,0,0,1-1.6,1.6ZM1.372,1.6V5.257a.229.229,0,0,0,.229.229H5.257a.229.229,0,0,0,.229-.229V1.6a.229.229,0,0,0-.229-.229H1.6A.229.229,0,0,0,1.372,1.6Z" transform="translate(0 0)" fill="#1e1e1e"/>
                </svg>
              </a>
              <div class="dropdown-menu dropdown-menu-end py-0" aria-labelledby="grid">
                <div class="dropdown-header d-flex align-items-center px-4 py-2">
                ...
                <div class="dropdown-footer text-center py-2 border-top border-gray-50">
                  <a href="#" class="btn btn-link link-dark
    ...
    <div class="container-fluid px-0">
      <div class="row align-items-center">
        <div class="col">
          ...
          <h1 class="h2 mb-0 lh-sm">Calendar</h1>
        </div>
        <div class="col-auto d-flex align-items-center my-2 my-sm-0">
          <a href="#" class="btn btn-lg btn-warning"><svg class="me-2" xmlns="http://www.w3.org/2000/svg" width="14.036" height="14.036" viewBox="0 0 14.036 14.036">
            <g id="Icon" transform="translate(0.036 0.036)">
              <rect id="Icons_Tabler_Adjustments_background" data-name="Icons/Tabler/Adjustments background" width="14" height="14" fill="none"/>
              <path id="Color" d="M11.2,13.458l0-.057V5.117a2.2,2.2,0,0,1,0-4.233V.6A.6.6,0,0,1,12.4.543L12.4.6V.883a2.2,2.2,0,0,1,0,4.233V13.4a.6.6,0,0,1-1.2.057ZM10.8,3a1,1,0,1,0,1-1A1,1,0,0,0,10.8,3ZM6.4,13.458l0-.057V12.317a2.2,2.2,0,0,1,0-4.233V.6A.6.6,0,0,1,7.6.543L7.6.6V8.083a2.2,2.2,0,0,1,0,4.233V13.4a.6.6,0,0,1-1.2.057ZM6,10.2a1,1,0,1,0,1-1A1,1,0,0,0,6,10.2ZM1.6,13.458l0-.057V7.516a2.2,2.2,0,0,1,0-4.234V.6A.6.6,0,0,1,2.8.543L2.8.6V3.283a2.2,2.2,0,0,1,0,4.233V13.4a.6.6,0,0,1-1.2.057ZM1.2,5.4a1,1,0,1,0,1-1A1,1,0,0,0,1.2,5.4Z" transform="translate(-0.036 -0.036)" fill="#1e1e1e"/>
            </g>
  ...
  <div class="p-3 p-xxl-5">
    <div class="container-fluid px-0 pb-4">
      <div class="bg-white border-top border-4 border-yellow-400 p-3">
