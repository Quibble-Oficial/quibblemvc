...
<head>
<title>Buy Muze Bootstrap 5 Empty or Blank Page</title>
<meta charset="UTF-8">
<meta name="description" content="Presenting Muze, All-in-one Bootstrap 5 Empty or Blank Admin Dashboard, 30+ Premium HTML Pages, 500+ components, dark mode, RTL. Starts @ Only $35
">
<meta name="title" content="Muze Bootstrap 5 Empty or Blank Page Templates, Themes, & Dashboard">
<meta name="keywords" content="bootstrap empty page, bootstrap blank template, bootstrap 5 blank template">
...
<body class="bg-gray-100 empty-state-template">
      ...
      <li class="nav-item">
        ...
        <div class="collapse collapse-box show" id="sidebarPages" data-bs-parent="#accordionExample">
          <ul class="nav nav-sm flex-column" id="submenu">
            ...
            <li class="nav-item">
              <a href="empty-state.html" class="nav-link active">Empty State</a>
            </li>
          </ul>
        </div>
      </li>
...
<div class="main-content">
  ...
  <div class="p-3 p-xxl-5 after-header">
    <div class="container-fluid px-0">
      <div class="row">
        <div class="col-12 text-center pt-4 pt-md-2 py-md-5">
          <h1>Hello Grogeous 👋</h1>
          <p class="text-black-600">Start by creating a fresh, new, awesome project</p>
          <div class="p-2 p-md-5">
            <img src="<?= $base;?>/assets/images/placeholder17.png" alt="Placeholder">
          </div>
          <div class="py-3 p-md-3">
            <a href="#0" class="btn btn-xl btn-primary">Start Awesomeness <svg class="ms-1" data-name="Icons/Tabler/Chevron Down" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 10 10">
              <rect data-name="Icons/Tabler/Chevron Right background" width="10" height="10" fill="none"/>
              <path d="M.163.163A.556.556,0,0,1,.886.109L.948.163,5.393,4.607a.556.556,0,0,1,.054.723l-.054.062L.948,9.837a.556.556,0,0,1-.839-.723l.054-.062L4.214,5,.163.948A.556.556,0,0,1,.109.225Z" transform="translate(2.5)" fill="#ffffff"/>
            </svg>
            </a>
          </div>
        </div>
