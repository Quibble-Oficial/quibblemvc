...
<head>
<title>Buy Muze Bootstrap 5 Invoice Page</title>
<meta charset="UTF-8">
<meta name="description" content="Presenting Muze, All-in-one Bootstrap 5 Invoice Admin Dashboard, 30+ Premium HTML pages, 500+ components, dark mode, RTL. Starts @ Only $35">
<meta name="title" content="Muze Bootstrap 5 Invoice Templates, Themes, & Dashboard">
<meta name="keywords" content="bootstrap invoice page, bootstrap Invoice template, invoice html template bootstrap, bootstrap 5 invoice template">
...
<body class="bg-gray-100 invoice-template">
                ...
                <div class="dropdown-body" data-simplebar>
                  ...
                  <a href="#" class="dropdown-item text-wrap">
                    <div class="media">
                      <span class="d-flex align-items-center">
                        <span class="avatar-status avatar-sm-status avatar-offline position-relative me-2 end-0 bottom-0">&nbsp;</span>
                        <span class="avatar avatar-xs shadow-sm rounded-circle me-2 d-flex align-items-center justify-content-center bg-white"><img src="V/assets/svg/icons/facebook3.svg" alt="Facebook"></span>
                      </span>
                      <div class="media-body ps-1">
                        <div class="d-flex align-items-center">
                  ...
                  <a href="#" class="dropdown-item text-wrap">
                    <div class="media">
                      <span class="d-flex align-items-center">
                        <span class="avatar-status avatar-sm-status avatar-offline position-relative me-2 end-0 bottom-0">&nbsp;</span>
                        <span class="avatar avatar-xs shadow-sm rounded-circle me-2 d-flex align-items-center justify-content-center bg-white"><img src="V/assets/images/avatar-sm2.png" alt="Facebook"><span class="avatar-status avatar-sm-status avatar-success">&nbsp;</span></span>
                      </span>
                      <div class="media-body ps-1">
                        <div class="d-flex align-items-center">
    ...
    <div class="container-fluid px-0">
      <div class="row align-items-center">
        <div class="col">
          ...
          <h1 class="h2 mb-0 lh-sm">Invoice details</h1>
        </div>
            ...
            <div class="card-body p-0 p-md-4">
              <div class="d-flex flex-wrap align-items-center">
                <span class="mb-3 mb-md-0 me-1">
                  <img src="<?= $base;?>/assets/svg/brand/logo.svg" alt="Muze" class="dark-logo">
                  <img src="<?= $base;?>/assets/svg/brand/logo-white.svg" class="white-logo" alt="Muze">
                </span>
                <div class="mb-3 mb-md-0 ms-auto d-flex flex-wrap align-items-center">
                  <a href="#0" class="btn btn-lg btn-outline-dark me-2 me-md-4">Share</a>
                  <div class="dropdown export-dropdown">
                    <a href="#"  role="button" id="Exportbtn" data-bs-toggle="dropdown" aria-expanded="false" class="btn btn-lg btn-primary">Export <svg class="ms-2" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14">
                      <rect data-name="Icons/Tabler/Download background" width="14" height="14" fill="none"/>
                      <path d="M6.683,13.91h0L6.673,13.9,6.661,13.9h0l-.009-.007,0,0-.009-.007h0l-.009-.007h0l-.01-.008h0q-.02-.017-.04-.036l-3.2-3.2a.6.6,0,0,1,.8-.892l.049.044L6.4,11.951V5.4a.6.6,0,0,1,1.2-.057l0,.057v6.551L9.776,9.776a.6.6,0,0,1,.892.8l-.044.049-3.2,3.2a.606.606,0,0,1-.077.065h0l-.01.007,0,0-.009.006,0,0-.007,0-.007,0,0,0-.009.005h0a.6.6,0,0,1-.608-.015ZM.6,1.2A.6.6,0,0,1,.543,0L.6,0H13.4a.6.6,0,0,1,.057,1.2l-.057,0Z" fill="#fff"/>
                    </svg>
                    </a>
              ...
              <div class="pt-4 pt-md-5">
                <h5 class="font-weight-semibold opensans-font">From: Fabrx Design LLC</h5>
                <p class="text-gray-700 mb-0">112 RE 34, New York, United States</p>
              </div>
              <div class="py-4 pb-md-5">
                <h5 class="font-weight-semibold opensans-font">Billed to: Bruce Lee</h5>
                <p class="text-gray-700 mb-0">334 SW 12th Ave KW5, Florida, United States</p>
              </div>
              <div class="border-top border-gray-200 pt-3 pt-sm-4 d-flex flex-wrap pb-2">
                <div class="row">
                  <div class="col-auto mt-2 mt-sm-3 px-3 pe-xxl-5">
                    ...
                    <h5 class="font-weight-semibold opensans-font mt-2">FD-FABRX-4456</h5>
                  </div>
                  <div class="col-auto mt-2 mt-sm-3 px-3 px-xxl-5">
                    <span class="text-gray-600">Due date</span>
                    <h5 class="font-weight-semibold opensans-font mt-2">15/06/2021</h5>
                  </div>
                  <div class="col-auto mt-2 mt-sm-3 px-3 px-xxl-5">
                    <span class="text-gray-600">Issue date</span>
                    <h5 class="font-weight-semibold opensans-font mt-2">12/05/2021</h5>
                  </div>
                  <div class="col-auto mt-2 mt-sm-3 px-3 px-xxl-5">
                    <span class="text-gray-600">Status</span>
                    <h5 class="font-weight-semibold opensans-font mt-2"><span class="avatar avatar-sm-status bottom-0 end-0 avatar-success avatar-border me-1">&nbsp;</span><span>Paid</span></h5>
                  </div>
                </div>
              </div>
              <div class="border-top border-gray-200 pt-md-4 mt-md-5">
                ...
                <div class="border-top border-gray-200 mt-4 pt-3 p-lg-4 mb-md-5">
                  <div class="row mt-md-2 py-1 py-md-2 pe-md-3">
                    ...
                    <div class="col-5 col-sm-3 col-xxl-1 text-end">
                      <span class="text-black-600">$8,000</span>
                    </div>
                  </div>
                  <div class="row py-1 py-md-2 pe-md-3">
                    <div class="col text-end">
                  ...
                  <div class="row py-1 py-md-2 pe-md-3">
                    <div class="col text-end">
                      <span class="font-weight-semibold text-black-600">Tax:</span>
                    </div>
                    <div class="col-5 col-sm-3 col-xxl-1 text-end">
                      <span class="text-black-600">$0</span>
                    </div>
                  </div>
                  <div class="row py-1 py-md-2 pe-md-3">
                    <div class="col text-end">
                      <span class="font-weight-semibold text-black-600">Amount paid:</span>
                    </div>
                    <div class="col-5 col-sm-3 col-xxl-1 text-end">
                      <span class="text-black-600">$8,000</span>
                    </div>
                  ...
                  <div class="row py-1 py-md-2 pe-md-3">
                    <div class="col text-end">
                      <span class="font-weight-semibold text-black-600">Due:</span>
                    </div>
                    <div class="col-5 col-sm-3 col-xxl-1 text-end">
                      <span class="text-black-600">$0</span>
                    </div>
                ...
                <p class="font-weight-semibold text-gray-600 mb-2 pt-3 pt-md-5">Have a question? Get in touch with our <a href="#0" class="link-primary">Support Team</a></p>
              </div>
            </div>
          </div>
        </div>
