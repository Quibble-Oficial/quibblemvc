...
<head>
<title>Buy Muze Bootstrap 5 Support & Help Page</title>
<meta charset="UTF-8">
<meta name="description" content="Presenting Muze, All-in-one Bootstrap 5 Support & Help Page Admin Dashboard, 30+ Premium HTML Pages, 500+ components, dark mode, RTL. Starts @ Only $35">
<meta name="title" content="Muze Bootstrap 5 Support & Help Page Templates, Themes, & Dashboard">
<meta name="keywords" content="bootstrap help page template, bootstrap support page template, contact and support">
...
<body class="bg-gray-100 help-center-template">
      ...
      <li class="nav-item">
        ...
        <div class="collapse collapse-box show" id="sidebarPages" data-bs-parent="#accordionExample">
          <ul class="nav nav-sm flex-column" id="submenu">
            ...
            <li class="nav-item">
              <a href="help-center.html" class="nav-link active">Help page</a>
            </li>
            <li class="nav-item">
...
<div class="main-content">
                    ...
                    <div class="dropdown-body" data-simplebar>
                      <a href="#" class="dropdown-item text-wrap">
                        <div class="media">
                          <span class="d-flex align-items-center">
                            ...
                            <span class="avatar avatar-xs shadow-sm rounded-circle me-2 d-flex align-items-center justify-content-center bg-white"><img src="<?= $base;?>/assets/images/avatar-sm3.png" alt="Facebook"><span class="avatar-status avatar-sm-status avatar-success">&nbsp;</span></span>
                          </span>
                      ...
                      <a href="#" class="dropdown-item text-wrap unread">
                        <div class="media">
                          <span class="d-flex align-items-center">
                            ...
                            <span class="avatar avatar-xs shadow-sm rounded-circle me-2 d-flex align-items-center justify-content-center bg-white"><img src="<?= $base;?>/assets/images/avatar-sm4.png" alt="Facebook"><span class="avatar-status avatar-sm-status avatar-success">&nbsp;</span></span>
                          </span>
                          <div class="media-body ps-1">
                            <div class="d-flex align-items-center">
                      ...
                      <a href="#" class="dropdown-item text-wrap">
                        <div class="media">
                          <span class="d-flex align-items-center">
                            <span class="avatar-status avatar-sm-status avatar-offline position-relative me-2 end-0 bottom-0">&nbsp;</span>
                            <span class="avatar avatar-xs shadow-sm rounded-circle me-2 d-flex align-items-center justify-content-center bg-white"><img src="<?= $base;?>/assets/images/avatar-sm5.png" alt="Facebook"><span class="avatar-status avatar-sm-status avatar-success">&nbsp;</span></span>
                          </span>
                          <div class="media-body ps-1">
                            <div class="d-flex align-items-center">
                      ...
                      <a href="#" class="dropdown-item text-wrap">
                        <div class="media">
                          <span class="d-flex align-items-center">
                            <span class="avatar-status avatar-sm-status avatar-offline position-relative me-2 end-0 bottom-0">&nbsp;</span>
                            <span class="avatar avatar-xs shadow-sm rounded-circle me-2 d-flex align-items-center justify-content-center bg-white"><img src="<?= $base;?>/assets/images/avatar-sm6.png" alt="Facebook"><span class="avatar-status avatar-sm-status avatar-success">&nbsp;</span></span>
                          </span>
                          <div class="media-body ps-1">
                            <div class="d-flex align-items-center">
                ...
                <div class="dropdown-body" data-simplebar>
                  <a href="#" class="dropdown-item text-wrap">
                    <div class="media">
                      <span class="d-flex align-items-center">
                        <span class="avatar-status avatar-sm-status avatar-offline position-relative me-2 end-0 bottom-0">&nbsp;</span>
                        <span class="avatar avatar-xs shadow-sm rounded-circle me-2 d-flex align-items-center justify-content-center bg-white"><img src="<?= $base;?>/assets/svg/icons/google-icon.svg" alt="Facebook"></span>
                      </span>
                      <div class="media-body ps-1">
                        <div class="d-flex align-items-center">
                  ...
                  <a href="#" class="dropdown-item text-wrap unread">
                    <div class="media">
                      <span class="d-flex align-items-center">
                        <span class="avatar-status avatar-sm-status avatar-primary position-relative me-2 end-0 bottom-0">&nbsp;</span>
                        <span class="avatar avatar-xs shadow-sm rounded-circle me-2 d-flex align-items-center justify-content-center bg-white"><img src="<?= $base;?>/assets/images/avatar-sm.png" alt="Facebook"><span class="avatar-status avatar-sm-status avatar-success">&nbsp;</span></span>
                      </span>
                      <div class="media-body ps-1">
                        <div class="d-flex align-items-center">
                  ...
                  <a href="#" class="dropdown-item text-wrap">
                    <div class="media">
                      <span class="d-flex align-items-center">
                        <span class="avatar-status avatar-sm-status avatar-offline position-relative me-2 end-0 bottom-0">&nbsp;</span>
                        <span class="avatar avatar-xs shadow-sm rounded-circle me-2 d-flex align-items-center justify-content-center bg-white"><img src="<?= $base;?>/assets/svg/icons/facebook3.svg" alt="Facebook"></span>
                      </span>
                      <div class="media-body ps-1">
                        <div class="d-flex align-items-center">
                  ...
                  <a href="#" class="dropdown-item text-wrap">
                    <div class="media">
                      <span class="d-flex align-items-center">
                        <span class="avatar-status avatar-sm-status avatar-offline position-relative me-2 end-0 bottom-0">&nbsp;</span>
                        <span class="avatar avatar-xs shadow-sm rounded-circle me-2 d-flex align-items-center justify-content-center bg-white"><img src="<?= $base;?>/assets/images/avatar-sm2.png" alt="Facebook"><span class="avatar-status avatar-sm-status avatar-success">&nbsp;</span></span>
                      </span>
                      <div class="media-body ps-1">
                        <div class="d-flex align-items-center">
                ...
                <div class="dropdown-body" data-simplebar>
                  <a href="#" class="dropdown-item text-wrap">
                    <div class="media align-items-center">
                      <span class="me-3">
                        <img class="avatar avatar-xs rounded-0" src="..<?= $base;?>/assets/svg/icons/google-analytics-3.svg" alt="Icon">
                      </span>
                  ...
                  <a href="#" class="dropdown-item text-wrap">
                    <div class="media align-items-center">
                      <span class="me-3">
                        <img class="avatar avatar-xs rounded-0" src="..<?= $base;?>/assets/svg/icons/dribbble-icon-1.svg" alt="Icon">
                      </span>
                      <div class="media-body">
                  ...
                  <a href="#" class="dropdown-item text-wrap">
                    <div class="media align-items-center">
                      <span class="me-3">
                        <img class="avatar avatar-xs rounded-0" src="..<?= $base;?>/assets/svg/icons/evernote-icon.svg" alt="Icon">
                      </span>
                      <div class="media-body">
                  ...
                  <a href="#" class="dropdown-item text-wrap">
                    <div class="media align-items-center">
                      <span class="me-3">
                        <img class="avatar avatar-xs rounded-0" src="<?= $base;?>/assets/svg/icons/dropbox.svg" alt="Icon">
                      </span>
                      <div class="media-body">
                  ...
                  <a href="#" class="dropdown-item text-wrap">
                    <div class="media align-items-center">
                      <span class="me-3">
                        <img class="avatar avatar-xs rounded-0" src="<?= $base;?>/assets/svg/icons/ios.svg" alt="Icon">
                      </span>
                      <div class="media-body">
  ...
  <div class="p-3 p-xxl-5 bg-primary after-header">
    <div class="container-fluid px-0 pb-5">
      <div class="row">
        <div class="col-md-10 col-lg-12 col-xxl-6 text-center pb-1 pt-4 px-4 mx-auto">
          <h1 class="display-4 text-white mb-2">Help Center</h1>
          <p class="fs-20 lh-lg text-white px-xxl-4 mb-0">We have plans and prices that fit your business perfectly. Make your client site a success with our products.</p>
        </div>
      </div>
    </div>
  </div>
  <div class="px-3 px-xxl-5 pb-3 pb-xxl-5">
    <div class="container-fluid px-0">
        ...
        <div class="shadow-dark-80 rounded bg-white py-3 px-4">
          <form class="d-md-flex align-items-center">
            <div class="d-flex align-items-center search-left">
              <span><img src="<?= $base;?>/assets/svg/icons/search@16.svg" alt="Search"></span>
      ...
      <div class="pt-2 py-xxl-5 mt-3">
        <div class="row">
          <div class="col-sm-6 col-xl-4 mb-4">
            <div class="h-100 bg-white rounded-12 shadow-dark-80 text-center py-5 px-4 px-lg-5">
              <span class="bg-yellow-500 circle circle-lg mb-3 m-auto"><img src="<?= $base;?>/assets/svg/icons/power-outline.svg" alt="General"></span>
              <h5 class="mt-4 font-weight-semibold"><a href="#" class="text-black-600">General</a></h5>
              <p class="lh-lg text-gray-700">Lorem Ipsum is simply dummy text of the printing and much more than this</p>
              <div class="mt-4"><span class="badge py-2 text-gray-600 bg-transparent border border-gray-700">14 articles</span></div>
            </div>
          </div>
          <div class="col-sm-6 col-xl-4 mb-4">
            <div class="h-100 bg-white rounded-12 shadow-dark-80 text-center py-5 px-4 px-lg-5">
              <span class="bg-yellow-500 circle circle-lg mb-3 m-auto"><img src="<?= $base;?>/assets/svg/icons/money.svg" alt="Payments"></span>
              <h5 class="mt-4 font-weight-semibold"><a href="#" class="text-black-600">Payments</a></h5>
              <p class="lh-lg text-gray-700">Sed ut perspiciatis unde omnis iste natus error sit voluptatem</p>
              <div class="mt-4"><span class="badge py-2 text-gray-600 bg-transparent border border-gray-700">12 articles</span></div>
            </div>
          </div>
          <div class="col-sm-6 col-xl-4 mb-4">
            <div class="h-100 bg-white rounded-12 shadow-dark-80 text-center py-5 px-4 px-lg-5">
              <span class="bg-yellow-500 circle circle-lg mb-3 m-auto"><img src="<?= $base;?>/assets/svg/icons/plug.svg" alt="Plugins"></span>
              <h5 class="mt-4 font-weight-semibold"><a href="#" class="text-black-600">Plugins</a></h5>
              <p class="lh-lg text-gray-700">At vero eos et accusamus et iusto odio dignissimos ducimus</p>
              <div class="mt-4"><span class="badge py-2 text-gray-600 bg-transparent border border-gray-700">4 articles</span></div>
            </div>
          </div>
          <div class="col-sm-6 col-xl-4 mb-4">
            <div class="h-100 bg-white rounded-12 shadow-dark-80 text-center py-5 px-4 px-lg-5">
              <span class="bg-yellow-500 circle circle-lg mb-3 m-auto"><img src="<?= $base;?>/assets/svg/icons/box-outline.svg" alt="Packages"></span>
              <h5 class="mt-4 font-weight-semibold"><a href="#" class="text-black-600">Packages</a></h5>
              <p class="lh-lg text-gray-700">Contrary to popular belief, Lorem Ipsum is not simply random</p>
              <div class="mt-4"><span class="badge py-2 text-gray-600 bg-transparent border border-gray-700">6 articles</span></div>
            </div>
          </div>
          <div class="col-sm-6 col-xl-4 mb-4">
            <div class="h-100 bg-white rounded-12 shadow-dark-80 text-center py-5 px-4 px-lg-5">
              <span class="bg-yellow-500 circle circle-lg mb-3 m-auto"><img src="<?= $base;?>/assets/svg/icons/code.svg" alt="Coding"></span>
              <h5 class="mt-4 font-weight-semibold"><a href="#" class="text-black-600">Coding</a></h5>
              <p class="lh-lg text-gray-700">It is a long established fact that a reader will be distracted</p>
              <div class="mt-4"><span class="badge py-2 text-gray-600 bg-transparent border border-gray-700">12 articles</span></div>
            </div>
          </div>
          <div class="col-sm-6 col-xl-4 mb-4">
            <div class="h-100 bg-white rounded-12 shadow-dark-80 text-center py-5 px-4 px-lg-5">
              <span class="bg-yellow-500 circle circle-lg mb-3 m-auto"><img src="<?= $base;?>/assets/svg/icons/user.svg" alt="Account"></span>
              <h5 class="mt-4 font-weight-semibold"><a href="#" class="text-black-600">Account</a></h5>
              <p class="lh-lg text-gray-700">There are many variations of passages of Lorem Ipsum</p>
              <div class="mt-4"><span class="badge py-2 text-gray-600 bg-transparent border border-gray-700">14 articles</span></div>
            </div>
          </div>
        </div>
      </div>
      <div class="pt-xxl-5 mt-2 border-top border-gray-200">
        <div class="text-center pt-3 mt-2">
          <h2 class="h1">Can’t find what you’re looking for?</h2>
          <p class="big lh-lg text-black-600">Reach out to our support team and we’ll get back to you within 24 <br class="d-none d-md-block">hours for any issue you might have!</p>
        </div>
        <div class="bg-white p-4 p-md-5 rounded-12 shadow-dark-80 my-4 my-xxl-5">
          <form>
            <div class="row">
              <div class="col-md-6">
                <div class="mb-4 mb-md-5">
                  <label class="form-label form-label-lg" for="FullName">Full name</label>
                  <input type="text" placeholder="Full name" id="FullName" class="form-control form-control-xl">
                </div>
              </div>
              <div class="col-md-6">
                <div class="mb-4 mb-md-5">
                  <label class="form-label form-label-lg" for="EmailAddress">Email address</label>
                  <input type="text" placeholder="Email address" id="EmailAddress" class="form-control form-control-xl">
                </div>
              </div>
              <div class="col-md-12">
                <div class="mb-4 mb-md-5">
                  <label class="form-label form-label-lg" for="Department">Department</label>
                  <select class="form-select form-select-xl" id="Department">
              ...
              <div class="col-md-12">
                <div class="mb-4 mb-md-5">
                  <label class="form-label form-label-lg" for="Message">Message</label>
                  <textarea class="form-control form-control-lg" id="Message" placeholder="Start typing" rows="4"></textarea>
                </div>
              </div>
            </div>
            <div class="row align-items-center">
              ...
              <div class="col-md-5">
                <div class="text-end"><button type="button" class="btn btn-xl btn-primary">Submit</button></div>
              </div>
            </div>
          </form>
        </div>
      ...
      <div class="row">
        <div class="mb-4 mt-3 mt-xxl-4">
          <h2 class="border-bottom border-gray-200 pb-3 pb-md-4 h1 border-top pt-4 pt-xxl-5 mb-0"><span class="d-block mb-xxl-3 mt-xxl-4 pt-xxl-2">Common questions</span></h2>
          <div class="accordion muze-collapes" id="pricingboxes">
            <div class="card">
              <div class="card-header p-0" id="pricingOne">
                <h5 class="mb-0 d-grid">
                  <button class="btn btn-light btn-block text-start p-3 rounded-0" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                    What is Fabrx Design?
                  </button>
                </h5>
              </div>
              <div id="collapseOne" class="collapse show" aria-labelledby="pricingOne" data-bs-parent="#pricingboxes">
            ...
            <div class="card">
              ...
              <div id="collapseTwo" class="collapse" aria-labelledby="pricingTwo" data-bs-parent="#pricingboxes">
                <div class="card-body lh-lg pt-0 px-0">
                  <div class="col-lg-10 col-xxl-8">
                    <p class="text-gray-700">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p>
                  </div>
            ...
            <div class="card">
              <div class="card-header p-0" id="pricingThree">
                <h5 class="mb-0 d-grid">
                  <button class="btn btn-light btn-block text-start collapsed p-3 rounded-0" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                    How can I start using the template?
                  </button>
                </h5>
              </div>
              <div id="collapseThree" class="collapse" aria-labelledby="pricingThree" data-bs-parent="#pricingboxes">
                <div class="card-body lh-lg pt-0 px-0">
                  <div class="col-lg-10 col-xxl-8">
                    <p class="text-gray-700">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p>
                  </div>
            ...
            <div class="card">
              <div class="card-header p-0" id="pricingFour">
                <h5 class="mb-0 d-grid">
                  <button class="btn btn-light btn-block text-start collapsed p-3 rounded-0" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                    What kind of support do you provide?
                  </button>
                </h5>
              </div>
              <div id="collapseFour" class="collapse" aria-labelledby="pricingFour" data-bs-parent="#pricingboxes">
                <div class="card-body lh-lg pt-0 px-0">
                  <div class="col-lg-10 col-xxl-8">
                    <p class="text-gray-700">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p>
                  </div>
            ...
            <div class="card">
              <div class="card-header p-0" id="pricingfive">
                <h5 class="mb-0 d-grid">
                  <button class="btn btn-light btn-block text-start collapsed p-3 rounded-0" type="button" data-bs-toggle="collapse" data-bs-target="#collapsefive" aria-expanded="false" aria-controls="collapsefive">
                    How do I download the template?
                  </button>
                </h5>
              </div>
              <div id="collapsefive" class="collapse" aria-labelledby="pricingfive" data-bs-parent="#pricingboxes">
                <div class="card-body lh-lg pt-0 px-0">
                  <div class="col-lg-10 col-xxl-8">
                    <p class="text-gray-700">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p>
                  </div>
            ...
            <div class="card">
              <div class="card-header p-0" id="pricingsix">
                <h5 class="mb-0 d-grid">
                  <button class="btn btn-light btn-block text-start collapsed p-3 rounded-0" type="button" data-bs-toggle="collapse" data-bs-target="#collapsesix" aria-expanded="false" aria-controls="collapsesix">
                    I have a problem
                  </button>
                </h5>
              </div>
              <div id="collapsesix" class="collapse" aria-labelledby="pricingsix" data-bs-parent="#pricingboxes">
                <div class="card-body lh-lg pt-0 px-0">
                  <div class="col-lg-10 col-xxl-8">
                    <p class="text-gray-700">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p>
                  </div>
        ...
        <div class="col-md-12 my-1 my-xxl-5">
          <div class="bg-blue-50 p-4 p-md-5 position-relative overflow-hidden rounded-12 mb-4 alert alert-dismissible zIndex-0" role="alert">
            <div class="row mb-0 mb-sm-5 mb-md-0 ps-xl-3">
              <div class="col-lg-12 col-xl-8 col-xxl-4 mb-md-5 mb-lg-0">
