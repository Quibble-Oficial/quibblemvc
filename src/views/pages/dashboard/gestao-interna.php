...
<div class="main-content">
  ...
  <div class="px-3 px-xxl-5 py-3 py-lg-4 border-bottom border-gray-200 after-header">
    <div class="container-fluid px-0">
      <div class="row align-items-center">
        <div class="col">
          <h1 class="h2 mb-0">Gestão Interna</h1>
        </div>
      ...
      <div class="filtro-container">
        ...
        <form class="filtro-form">
            <div class="filtro-group">
                ...
                <div class="filtro-item">
                    <span class="icon">
                        <svg width="22" height="22" fill="none" stroke="#bdbdbd" stroke-width="2" viewBox="0 0 24 24"><rect x="3" y="4" width="18" height="18" rx="4"></rect><path d="M16 2v4M8 2v4M3 10h18"></path></svg>
                    </span>
    ...
    <div class="row">
          ...
          <div class="card rounded-12 shadow-dark-80 border border-gray-50">
            <div class="card-body px-0">
              ...
              <div class="card-body-inner px-3 px-md-4">
                <div id="MuzeMultipleColumnsChartOne" class="px-md-2" data-highcharts-chart="0" style="overflow: hidden; position: relative; width: 100%; height: auto;"></div>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="card-body p-3 px-xxl-4">
              <div class="row align-items-center">
                ...
                <div class="col-7 col-xxl-6" style="position: relative;">
                  <div id="MuzeSimpleDonut" style="min-height: 107.8px;"><div id="apexcharts22ksbq0s" class="apexcharts-canvas apexcharts22ksbq0s apexcharts-theme-light" style="width: 136.375px; height: 107.8px;"><svg id="SvgjsSvg1130" width="136.375" height="107.8" xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.com/svgjs" class="apexcharts-svg" xmlns:data="ApexChartsNS" transform="translate(0, 0)" style="background: transparent;"><g id="SvgjsG1132" class="apexcharts-inner apexcharts-graphical" transform="translate(33.6875, 0)"><defs id="SvgjsDefs1131"><clipPath id="gridRectMask22ksbq0s"><rect id="SvgjsRect1134" width="105" height="123" x="-2" y="0" rx="0" ry="0" opacity="1" stroke-width="0" stroke="none" stroke-dasharray="0" fill="#fff"></rect></clipPath><clipPath id="gridRectMarkerMask22ksbq0s"><rect id="SvgjsRect1135" width="105" height="127" x="-2" y="-2" rx="0" ry="0" opacity="1" stroke-width="0" stroke="none" stroke-dasharray="0" fill="#fff"></rect></clipPath></defs><g id="SvgjsG1136" class="apexcharts-pie"><g id="SvgjsG1137" transform="translate(0, 0) scale(1)"><circle id="SvgjsCircle1138" r="29.424390243902444" cx="50.5" cy="50.5" fill="transparent"></circle><g id="SvgjsG1139" class="apexcharts-slices"><g id="SvgjsG1140" class="apexcharts-series apexcharts-pie-series" seriesName="seriesx1" rel="1" data:realIndex="0"><path id="SvgjsPath1141" d="M 50.5 5.231707317073166 A 45.268292682926834 45.268292682926834 0 0 1 50.5 95.76829268292684 L 50.5 79.92439024390245 A 29.424390243902444 29.424390243902444 0 0 0 50.5 21.075609756097556 L 50.5 5.231707317073166 z" fill="rgba(168,203,254,1)" fill-opacity="1" stroke-opacity="1" stroke-linecap="butt" stroke-width="0" stroke-dasharray="0" class="apexcharts-pie-area apexcharts-donut-slice-0" index="0" j="0" data:angle="180" data:startAngle="0" data:strokeWidth="0" data:value="50" data:pathOrig="M 50.5 5.231707317073166 A 45.268292682926834 45.268292682926834 0 0 1 50.5 95.76829268292684 L 50.5 79.92439024390245 A 29.424390243902444 29.424390243902444 0 0 0 50.5 21.075609756097556 L 50.5 5.231707317073166 z"></path></g><g id="SvgjsG1142" class="apexcharts-series apexcharts-pie-series" seriesName="seriesx2" rel="2" data:realIndex="1"><path id="SvgjsPath1143" d="M 50.5 95.76829268292684 A 45.268292682926834 45.268292682926834 0 0 1 50.49209919249937 5.231708006548686 L 50.49486447512459 21.075610204256645 A 29.424390243902444 29.424390243902444 0 0 0 50.5 79.92439024390245 L 50.5 95.76829268292684 z" fill="rgba(13,110,253,1)" fill-opacity="1" stroke-opacity="1" stroke-linecap="butt" stroke-width="0" stroke-dasharray="0" class="apexcharts-pie-area apexcharts-donut-slice-1" index="0" j="1" data:angle="180" data:startAngle="180" data:strokeWidth="0" data:value="50" data:pathOrig="M 50.5 95.76829268292684 A 45.268292682926834 45.268292682926834 0 0 1 50.49209919249937 5.231708006548686 L 50.49486447512459 21.075610204256645 A 29.424390243902444 29.424390243902444 0 0 0 50.5 79.92439024390245 L 50.5 95.76829268292684 z"></path></g></g></g></g><line id="SvgjsLine1144" x1="0" y1="0" x2="101" y2="0" stroke="#b6b6b6" stroke-dasharray="0" stroke-width="1" class="apexcharts-ycrosshairs"></line><line id="SvgjsLine1145" x1="0" y1="0" x2="101" y2="0" stroke-dasharray="0" stroke-width="0" class="apexcharts-ycrosshairs-hidden"></line></g><g id="SvgjsG1133" class="apexcharts-annotations"></g></svg><div class="apexcharts-legend"></div></div></div>
                <div class="resize-triggers"><div class="expand-trigger"><div style="width: 161px; height: 109px;"></div></div><div class="contract-trigger"></div></div></div>
              </div>
            </div>
          </div>
      ...
      <div class="row">
        <div class="col-9 mb-4">
          <div class="card rounded-12 shadow-dark-80">
            <div class="d-flex align-items-center px-3 px-md-4 py-3">
              <h5 class="card-header-title mb-0 ps-md-2 font-weight-semibold">Tabelas de Acompanhamento</h5>
              <div class="dropdown export-dropdown ms-auto pe-md-2">
              ...
              <table class="table card-table table-nowrap overflow-hidden">
                ...
                <tbody class="list">
                  ...
                  <tr>
                    ...
                    <td><a href="http://localhost/quibblemvc/public/assets/images/avatar-sm2.png"></a>+1</td>
                    <td>01/12/21</td>
                    <td>
                      <div class="dropdown text-end">
                        <a href="#" class="btn btn-dark-100 btn-icon btn-sm rounded-circle" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
