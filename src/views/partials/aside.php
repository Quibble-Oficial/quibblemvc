<aside>
  ...
  <div class="aside-content">
    <nav>
      <ul>
        <li>
          <a href="<?= $base; ?>/"><img src="<?= $base; ?>/assets/images/home.svg" alt="" />
            <div>Feed</div>
          </a>
        </li>
        <li>
        ...
        <li>
          <a href="<?= $base; ?>/notificacoes"><img src="<?= $base; ?>/assets/images/sino.svg" alt="" />
            <div>Notificações</div>
          </a>
        </li>
        <li>
          <a href="<?= $base; ?>/comunidade"><img src="<?= $base; ?>/assets/images/comunidade.svg" alt="" />
            <div>Comunidade</div>
          </a>
        </li>
        <li>
    ...
    <div id="nav-secundario">
      <ul>
        <li>
          <a href="#"><img src="<?= $base; ?>/assets/images/lua.svg" alt="" />
            <div>Tema</div>
          </a>
        </li>
        <li>
          <a href="ajuda.html"><img src="<?= $base; ?>/assets/images/ajuda.svg" alt="" />
            <div>Ajuda</div>
          </a>
        </li>
        <li>
          <a href="config.html"><img src="<?= $base; ?>/assets/images/config.svg" alt="" />
