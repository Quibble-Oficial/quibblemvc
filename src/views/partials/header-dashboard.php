      ...
      <div class="header-body-lizzzzzzzzzzzz px-3 px-xxl-5 py-3 py-lg-4">
        <div class="row align-items-center">
          ...
          <div class="col d-flex align-items-center">
            ...
            <!-- CABEÇALHO TOPO (SIDEBAR + CABEÇALHO) -->
              ...
              <div class="dropdown-menu dropdown-menu-end py-0" aria-labelledby="notification">
                <div class="dropdown-header d-flex align-items-center px-4 py-2 border-bottom border-gray-200">
                  ...
                  <div class="dropdown ms-auto">
                    <a href="#" role="button"  data-bs-toggle="dropdown" aria-expanded="false" id="morebtn2" class="btn btn-dark-100 btn-icon btn-sm rounded-circle my-1">
                ...
                <ul class="nav nav-tabs nav-tabs-sm nav-tabs-line" id="myTab" role="tablist">
                  <li class="nav-item" role="presentation">
                    <a class="nav-link active" id="home-tab" data-bs-toggle="tab" href="#Inbox" role="tab" aria-selected="true">Caixa de entrada</a>
                  </li>
                  <li class="nav-item" role="presentation">
                    <a class="nav-link" id="profile-tab" data-bs-toggle="tab" href="#Archived" role="tab" aria-selected="false">Arquivadas</a>
                  </li>
                </ul>
                    ...
                    <div class="dropdown-body" data-simplebar>
                        ...
                        <div class="media">
                          ...
                          <div class="media-body ps-1">
                            <div class="d-flex align-items-center">
                              <span class="fs-16 font-weight-semibold dropdown-title">Carlos Augusto Dantas</span>
                              <span class="font-weight-semibold tiny text-gray-600 ms-auto">Agora mesmo</span>
                            </div>
                      ...
                      <a href="#" class="dropdown-item text-wrap unread">
                        <div class="media">
                          ...
                          <div class="media-body ps-1">
                            <div class="d-flex align-items-center">
                              <span class="fs-16 font-weight-semibold dropdown-title">Gabriel Souza</span>
                              <span class="font-weight-semibold tiny text-gray-600 ms-auto">Agora mesmo</span>
                            </div>
                      ...
                      <a href="#" class="dropdown-item text-wrap">
                        <div class="media">
                          ...
                          <div class="media-body ps-1">
                            <div class="d-flex align-items-center">
                              <span class="fs-16 font-weight-semibold dropdown-title">Juliana Bertolani</span>
                              <span class="font-weight-semibold tiny text-gray-600 ms-auto">Agora mesmo</span>
                            </div>
                      ...
                      <a href="#" class="dropdown-item text-wrap">
                        <div class="media">
                          ...
                          <div class="media-body ps-1">
                            <div class="d-flex align-items-center">
                              <span class="fs-16 font-weight-semibold dropdown-title">Bernardo Cota</span>
                              <span class="font-weight-semibold tiny text-gray-600 ms-auto">Agora mesmo</span>
                            </div>
                            <span class="d-block small text-gray-600 mt-1 dropdown-content">Hey, I just found out what’s causing the server to crash!</span>
                          </div>
            ...
            <!-- <div class="dropdown grid-option">
              ...
              <div class="dropdown-menu dropdown-menu-end py-0" aria-labelledby="chat">
                <div class="dropdown-header d-flex align-items-center px-4 py-2">
                  <span class="fs-16 Montserrat-font font-weight-semibold text-black-600">Mensagens</span>
                  <div class="dropdown ms-auto">
